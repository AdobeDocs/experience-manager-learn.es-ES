...
1. AEM Inicie sesión en el servicio de **Autor** de utilizado en el capítulo anterior.
1. AEM En la pantalla de inicio de la, haga clic en **Sitios** > **Sitio WKND** > **Inglés** > **Artículo**
...
1. Elija la plantilla **Página de artículo** y haga clic en **Siguiente**.
   ...
   AEM Las páginas de la plantilla de página se crean a partir de una plantilla de página. Las plantillas de página se exploran en detalle en el capítulo [Plantillas de página](page-templates.md).
...
## Actualizaciones de Publish {#publish-updates}

AEM Los entornos de se dividen entre **Servicio de creación** y **Servicio de Publish**. En este capítulo hemos realizado varias modificaciones en el sitio en el **servicio de creación**. Para que los visitantes del sitio puedan ver los cambios, debemos publicarlos en **Publish Service**.

![Diagrama de alto nivel](assets/author-content-publish/author-publish-high-level-flow.png)

*Flujo de contenido de alto nivel de Author a Publish*
...
**3.** visitantes del sitio verán los cambios reflejados en el servicio de Publish.

### Publish los cambios

A continuación, vamos a publicar los cambios.

1. AEM En la pantalla de inicio de la, vaya a **Sitios** y seleccione el **Sitio WKND**.
...
1. En **Opciones**, deje la configuración predeterminada en **Publish** y programe para **Ahora**. Haga clic en **Siguiente**.
...
1. Haga clic en el botón **Referencias publicadas**. En el cuadro de diálogo, compruebe que todo está marcado. Esto incluirá la **Plantilla de sitio estándar** y varias configuraciones generadas por la Plantilla de sitio. Haga clic en **Listo** para actualizar.
   ...
   ![referencias de Publish](assets/author-content-publish/publish-references.png)

1. Finalmente, marque la casilla junto al **Sitio WKND** y haga clic en **Siguiente** en la esquina superior derecha.
1. En el paso **Flujos de trabajo**, escriba un **título de flujo de trabajo**. Puede ser cualquier texto y puede resultar útil como parte de una pista de auditoría más adelante. Escriba &quot;Publicación inicial&quot; y haga clic en **Publish**.
...
A continuación, vaya al servicio Publish para ver los cambios.

1. Una manera sencilla de obtener la dirección URL del servicio Publish es copiar la dirección URL del autor y reemplazar la palabra `author` por `publish`. Por ejemplo:

   * **URL del autor** - `https://author-pYYYY-eXXXX.adobeaemcloud.com/`
   * **URL DE Publish** - `https://publish-pYYYY-eXXXX.adobeaemcloud.com/`

1. Agregue `/content/wknd.html` a la dirección URL de Publish para que la dirección URL final tenga el siguiente aspecto: `https://publish-pYYYY-eXXXX.adobeaemcloud.com/content/wknd.html`.
...
1. Al navegar a la dirección URL de Publish AEM, debería ver el sitio sin ninguna de las funcionalidades de creación de.
...
1. AEM Vuelva al **Servicio de autor de** y realice algunos cambios de contenido adicionales en el editor de páginas.
1. Publish realiza estos cambios directamente desde el editor de páginas haciendo clic en el icono **Propiedades de página** > **Página de Publish**

   ![publicar directamente](assets/author-content-publish/page-editor-publish.png)

1. AEM Vuelva al **servicio de Publish** para ver los cambios. Lo más probable es que **no** vea inmediatamente las actualizaciones. AEM Esto se debe a que el **servicio de Publish** incluye [almacenamiento en caché a través de un servidor web Apache y CDN](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/content-delivery/caching.html). De forma predeterminada, el contenido del HTML se almacena en caché durante ~5 minutos.
...
1. También puede encontrar la URL del servicio de Publish en Cloud Manager. Vaya a **Programa de Cloud Manager** > **Entornos** > **Entorno**.

   ![Ver servicio de Publish](assets/author-content-publish/view-environment-segments.png)

   En **Segmentos de entorno** encontrará vínculos a los servicios **Autor** y **Publish**.
