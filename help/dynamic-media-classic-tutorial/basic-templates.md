...
- Obtenga más información sobre [Conceptos básicos de plantilla](https://experienceleague.adobe.com/docs/dynamic-media-classic/using/template-basics/quick-start-template-basics.html).
...
- **Mantener capas.** Esta es la opción más importante. Esto le indica a Dynamic Media Classic que cree un recurso de imagen por capa de Photoshop. Si no se selecciona, todas las demás opciones se desactivan y el PSD se acopla en una sola imagen.
...
- **Nombre de capa.** Esto indica a Dynamic Media Classic cómo asignar un nombre a cada recurso generado por capa. Se recomienda **Photoshop** **y Layer** **Name** o Photoshop y **Layer** **Number**. Ambas opciones utilizan el nombre PSD como primera parte del nombre y añaden el nombre o número de la capa al final. Por ejemplo, si tiene un PSD denominado &quot;camisa.psd&quot; y tiene capas denominadas &quot;anverso&quot;, &quot;mangas&quot; y &quot;cuello&quot;, si carga con las opciones **Photoshop y** Capa **Nombre**, Dynamic Media Classic generaría los ID de recurso &quot;cuello_camisa&quot;, &quot;camisa_manga&quot; y &quot;camisa_cuello&quot;. El uso de una de estas opciones ayuda a garantizar que el nombre sea único en Dynamic Media Classic.
...
6. Haga clic en **Guardar**, elija una ubicación y asigne un nombre a la plantilla. Puede obtener una vista previa, pero en este momento la plantilla se verá exactamente igual que una imagen de Photoshop plana; aún no se puede cambiar.
...
Obtenga más información sobre[Añadir efectos de capa](https://experienceleague.adobe.com/docs/dynamic-media-classic/using/template-basics/creating-template.html#using-shadow-and-glow-effects-on-layers).
...
1. Seleccione la opción **On** junto al nombre de cada propiedad que desee convertir en un parámetro. Aparecerá un nombre de parámetro predeterminado. Solo puede agregar parámetros a propiedades que han cambiado de su estado predeterminado.
   ...
   - Por ejemplo, si agrega una capa y la mantiene en su posición xy predeterminada de 0,0, Dynamic Media Classic no expondrá una propiedad **Position**. Para arreglarlo, mueva la capa al menos un píxel. Ahora, Dynamic Media Classic mostrará **Position** como una propiedad que puede parametrizar.
...
Obtenga más información sobre [Parámetros de plantilla](https://experienceleague.adobe.com/docs/dynamic-media-classic/using/template-basics/creating-template-parameters.html).
...
4. Para dar formato al texto, selecciónelo arrastrando con el ratón y elija un control de formato en la interfaz de usuario.
   ...
   - A diferencia de Photoshop y Illustrator, Image Server puede alinear el texto verticalmente en el cuadro de texto. El valor predeterminado es la alineación superior. Para cambiar esto, seleccione el texto y elija **Middle** o **Bottom** en el menú **Vertical Alignment**.
...
Obtenga más información sobre [Publicación de la plantilla](https://experienceleague.adobe.com/docs/dynamic-media-classic/using/template-basics/publishing-templates.html).
