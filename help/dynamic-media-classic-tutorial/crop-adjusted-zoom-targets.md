...
Dynamic Media Classic dispone de algunas herramientas de edición de imágenes que están disponibles en la IU, incluida la herramienta Recortar. Es posible que desee recortar la imagen maestra dentro de Dynamic Media Classic por varios motivos. Por ejemplo:
...
Puede acceder a la herramienta Recortar en Dynamic Media Classic desde la página Detalles de un recurso o haciendo clic en el botón **Editar** botón. Puede utilizar la herramienta para recortar de dos formas:

- El modo de recorte predeterminado en el que se arrastran los controles de la ventana de recorte o se escriben valores en el cuadro Tamaño. Obtenga información sobre cómo [Recortar manualmente](https://experienceleague.adobe.com/docs/dynamic-media-classic/using/master-files/cropping-image.html#select-an-area-to-crop).
- Recortar. Utilice esto para eliminar espacios en blanco adicionales alrededor de la imagen calculando el número de píxeles que no coinciden con la imagen. Obtenga información sobre cómo [Recortar](https://experienceleague.adobe.com/docs/dynamic-media-classic/using/master-files/cropping-image.html#crop-to-remove-white-space-around-an-image).
...
>[!NOTE]
>
>El recorte no crea transparencia alrededor de la imagen. Para ello, debe incrustar una ruta de recorte en la imagen y utilizar la variable **Crear máscara a partir de la ruta del clip** opción de carga.
>
>Además, para restaurar una imagen a su estado original después de recortarla cuando haya utilizado la variable **Guardar** , muestre la imagen en la pantalla Editor de recorte y seleccione la opción **Restablecer** botón.

### _Recorte al cargar_

Como se ha mencionado anteriormente, también puede elegir recortar las imágenes a medida que las carga. Para utilizar recortes al cargar, haga clic en el botón **Opciones de trabajo** y, en Opciones de recorte, elija **Recortar**.
...
>[!IMPORTANT]
>
>Si establece un recorte para la carga, Dynamic Media Classic colocará una cookie para recordar esa configuración la próxima vez. Como práctica recomendada, haga clic en el botón **Restaurar a valores predeterminados de la empresa** antes de la siguiente carga para borrar las opciones de recorte que haya quedado desde la última carga; de lo contrario, podría recortar accidentalmente el siguiente lote de imágenes.
...
_Modificadores del comando Recortar en la parte inferior del Editor de recorte_
...
1. Vaya a la imagen y haga clic en el botón **Editar** y elija **Destinos de zoom**.
...
3. Mueva el cuadro rojo con el ratón y haga clic en para crear un nuevo destino.
   ...
   - El tamaño objetivo viene determinado por el tamaño de vista dentro del ajuste preestablecido de visor. Esto determina el tamaño de la imagen de zoom principal. Consulte _Configuración del tamaño de la vista_, más abajo.
...
5. Para cambiar el nombre del objetivo, haga clic en su miniatura y escriba una nueva **Nombre** y haga clic en **Entrar** o **Tabulación** — si simplemente haces clic en otro lugar, tu nombre no se guardará.
6. Mientras se selecciona el objetivo, el cuadro tendrá líneas discontinuas verdes alrededor de él y puede cambiar el tamaño y moverlo. Arrastre las esquinas para cambiar el tamaño o arrastre el cuadro de destino para moverlo.
   ...
   - Al igual que todos los demás trabajos que realice en Dynamic Media Classic, debe publicar para que los destinos de zoom estén activos en la web. Si ya utiliza un visor que admita los objetivos, estos aparecerán inmediatamente (una vez que se borre la caché). Sin embargo, si no utiliza un visor con la opción Destino de zoom habilitada, permanecerán ocultos.

      ![imagen](assets/crop-adjusted-zoom-targets/zoom-target-green-box.jpg)

7. Además, si necesita eliminar un objetivo, selecciónelo haciendo clic en su miniatura y presione la tecla **Eliminar Target** o pulse la tecla DELETE del teclado.
8. Siga haciendo clic en para agregar nuevos destinos, cambiar el nombre o cambiar el tamaño después de agregarlos.
9. Cuando haya terminado, haga clic en el botón **Guardar** y, a continuación, **Vista previa**.
...
1. En Ajustes preestablecidos de visor, vaya a la **Configuración de zoom** .
