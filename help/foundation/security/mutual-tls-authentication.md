---
title: Autenticación de seguridad de la capa de transporte mutuo (mTLS)
...
# Autenticación de seguridad de la capa de transporte mutuo (mTLS)
...
AEM Si utiliza una CA autofirmada para el certificado de la certificación, como se ha indicado anteriormente, intercambie el certificado o el certificado de la entidad de certificación (CA) interno con el proveedor de la API.
