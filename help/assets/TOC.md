...
+ Listas de reproducción de vídeos{#video-playlists}
...
+ Configuración{#configuring}
   ...
   + [Esquemas de la carpeta de metadatos](configuring/metadata-folder-schemas.md)
...
+ Creación{#authoring}
   + [Cambiar de vista](./authoring/switch-views.md)
   ...
   + [Relacionar y cancelar relación](./authoring/relate-unrelate.md)
...
+ Colaboración{#collaboration}
   ...
   + [Archivar y desproteger](./collaboration/check-in-and-check-out.md)
...
+ Búsqueda y descubrimiento{#search-and-discovery}
   ...
   + [Búsqueda por IA](./search-and-discovery/ai-search.md)
...
+ Funciones avanzadas{#advanced}
   ...
   + [Salida de PDF con anotaciones](./advanced/customizing-annotations-pdf-output.md)
   ...
   + [Permisos basados en metadatos](./advanced/metadata-driven-permissions.md)
   + [Subtítulos de vídeo](./advanced/video-closed-captions.md)
   + [Marcas de agua](./advanced/watermarks.md)
   + [Carga programática de recursos](./advanced/programmatic-asset-upload.md)

+ Administración avanzada de metadatos{#metadata}
   + [Metadatos de GenAI](metadata/genai-metadata.md)
   ...
   + [Etiquetas inteligentes para imágenes](metadata/custom-smart-tags.md)
...
+ Content Hub{#content-hub}
   ...
   + [Configuración](./content-hub/configure.md)
   ...
   + [Control de acceso basado en atributos](./content-hub/attribute-based-access-control.md)
...
+ Adobe GenStudio{#adobe-genstudio}
   + [AEM Assets y GenStudio for Performance Marketing](https://experienceleague.adobe.com/es/docs/integrations-learn/experience-cloud/tutorials/genstudio-for-performance-marketing-experience-manager/overview)
...
+ Uso compartido y distribución{#sharing}
   ...
   + Brand Portal{#brand-portal}
      ...
      + [Configurar el origen de los recursos](brand-portal/configure-asset-sourcing.md)
      + [Habilitar descargas de representación](brand-portal/enable-renditions-download.md)

   + Uso compartido de recursos{#assets-share}
      + [Commons del uso compartido de recursos](./sharing/asset-share-commons-user-experience-feature-video-understand.md)
      + [Configuración de Commons de uso compartido de recursos en AEM local](./sharing/asset-share-commons-technical-video-setup.md)
      + [Temáticas de Commons de uso compartido de recursos](./sharing/asset-share-commons-feature-video-theming.md)
      + [Kits de recursos de Commons de uso compartido de recursos](./sharing/asset-share/asset-share-commons-asset-kits.md)
...
+ Adobe Asset Link{#adobe-asset-link}
   ...
   + [Información general de panel](./adobe-asset-link/panel-overview.md)
   ...
   + [Registro de entrada y salida](./adobe-asset-link/check-in-check-out.md)
   ...
   + [Búsqueda de recurso](./adobe-asset-link/asset-search.md)

+ Automatización de contenidos{#content-automation}
...
+ Dynamic Media{#dynamic-media}
   ...
   + Vídeo {#video}
      + [Prácticas recomendadas](dynamic-media/dynamic-media-video-best-practices.md)
      ...
      + [Streaming adaptable DASH](dynamic-media/dynamic-media-dash.md)
   ...
   + Uso con AEM Sites {#dm-with-aem-sites}
   ...
   + Tutoriales {#tutorials}
      ...
      + [Descarga de recursos en la aplicación de Dynamic Media Classic](dynamic-media/tutorials/how-to-download-asset-in-dynamic-media-classic-app.md)
...
+ Integración de Workfront{#workfront}
   + Conector mejorado{#enhanced-connector}
      + [Conceptos básicos sobre el conector mejorado](./workfront/enhanced-connector/basics.md)
      + [Carpetas del proyecto](./workfront/enhanced-connector/project-folders.md)
      + Series de expertos de AEM{#aem-experts-series}
         ...
         + [Formularios de Workfront y metadatos de AEM](./workfront/enhanced-connector/aem-experts-series/custom-forms.md)
         ...
         + [Flujos de trabajo y ajustes avanzados](./workfront/enhanced-connector/aem-experts-series/advanced-settings-and-workflows.md)

+ Traducción {#translation}
   + [Traducción de archivos de origen](translation/source-file-translation-feature-video-use.md)

+ Plantillas de recursos{#asset-templates}
   + [Descripción de las plantillas de recursos](asset-templates/asset-templates-tutorial-understand.md)
   + [Uso de plantillas de recursos](asset-templates/asset-templates-feature-video-use.md)
   + [Configurar las plantillas de recursos](asset-templates/asset-templates-technical-video-setup.md)
   + [Uso de catálogos de recursos](asset-templates/asset-catalog-template-feature-video-use.md)

+ Implementación{#deployment}
   + [Multitenencia y desarrollo simultáneo](deployment/multitenancy-concurrent-article-understand.md)
