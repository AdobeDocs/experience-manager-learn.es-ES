...
* **\&lt;code>assetAnalytics.dispatcher.init()\&lt;code>** : acepta opcionalmente un objeto AppMeasurement; si se proporciona, no intenta crear una nueva instancia del objeto AppMeasurement.
