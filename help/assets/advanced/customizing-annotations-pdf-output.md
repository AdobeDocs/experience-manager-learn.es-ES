---
title: Personalizar anotaciones en AEM Assets
description: Los desarrolladores de AEM pueden configurar el formato y el estilo de los AEM Assets cuando se genera un resultado en PDF.
...
# Personalizar anotaciones en AEM Assets{#using-annotations-in-aem-assets}

AEM admite la personalización de la salida de la anotación a PDF.

## PDF annotation sling:definición de OsgiConfig

Para personalizar anotaciones de PDF, cree un nodo **sling:OsgiConfig** en su proyecto de AEM en
