...
seo-title: Tutorials y vídeos de AEM Forms
...
Adobe Experience Manager (AEM) proporciona una solución fácil de usar para crear, administrar, publicar y actualizar formularios digitales complejos al tiempo que se integra con los procesos back-end, las reglas comerciales y los datos. Esta guía del usuario contiene vídeos y tutoriales sobre las muchas funciones y capacidades de AEM Forms
...
<tr>
  <td>
    ...
    <div>
      <a href="./creating-your-first-adaptive-form/introduction-and-setup.md">
    <strong>Crear el primer formulario adaptable</strong>
    </a>
    </div>
    <p>
