...
El primer paso para rellenar un formulario adaptable desde un archivo PDF es exportar los datos del archivo PDF dado y almacenarlos en el repositorio de AEM.
