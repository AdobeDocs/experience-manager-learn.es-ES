...
![flujo de trabajo principal](assets/update-signature.PNG)
...
El flujo de trabajo de actualización del estado de la firma se puede [descargar desde aquí](assets/update-signature-status-workflow.zip)
