---
title: Crear un servicio de rellenado previo para un formulario adaptable basado en componentes principales
description: Rellene previamente el servicio para recuperar datos y archivos adjuntos.
...
Para rellenar previamente el formulario con los datos enviados y los archivos adjuntos, se ha escrito el siguiente servicio de relleno previo
...
## Código para recuperar datos de Azure
...
## Asociar el servicio de rellenado previo con el formulario

Asocie el servicio de rellenado previo personalizado al formulario adaptable como se muestra a continuación

![prefill-service](assets/prefill-service.png)

Obtenga una vista previa del formulario incluyendo el parámetro guid en la dirección URL como se muestra a continuación
