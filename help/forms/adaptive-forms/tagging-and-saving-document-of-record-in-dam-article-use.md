...
description: Este artículo explicará el caso de uso de almacenamiento y etiquetado del DoR generado por AEM Forms en AEM DAM. El etiquetado del documento se realiza en función de los datos del formulario enviado.
...
Este artículo explicará el caso de uso de almacenamiento y etiquetado del DoR generado por AEM Forms en AEM DAM. El etiquetado del documento se realiza en función de los datos del formulario enviado.
...
* Al enviar el formulario, se activa un flujo de trabajo de AEM. Este flujo de trabajo etiqueta el documento con el estado civil (soltero) y el estado laboral (retirado) y almacena el documento en DAM.
...
* [Importe los recursos del artículo](assets/tag-and-store-in-dam-assets.zip) mediante el administrador de paquetes de AEM
