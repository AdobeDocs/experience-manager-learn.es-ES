...
AEM Para integrar el servicio de datos de AEM Forms/con aplicaciones de terceros, necesitamos [crear una fuente de datos](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/ic-web-channel-tutorial/parttwo.html) en la configuración de los servicios en la nube.
...
* AEM [Descargue el modelo de datos de formulario](assets/sms-2fa-fdm.zip) e impórtelo a las carpetas mediante el uso de [administrador de paquetes](http://localhost:4502/crx/packmgr/index.jsp).
