...
AEM Si, por alguna razón, no puede generar el flujo de trabajo, puede descargar el flujo de trabajo completado desde [aquí](assets/review-submitted-data-workflow.zip) e importarlo mediante [el administrador de paquetes](http://localhost:4502/crx/packmgr/index.jsp) en su instancia de.
