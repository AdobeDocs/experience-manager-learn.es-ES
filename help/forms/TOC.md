...
+ Creación del primer formulario adaptable {#creating-your-first-adaptive-form}
   ...
   + [Añadir componentes en el panel Personas](creating-your-first-adaptive-form/adding-components-to-people-panel.md)
...
+ Gestión de envíos de formularios {#handling-af-form-submissions}
   + [Creación de un flujo de trabajo de revisión](handling-form-submissions/create-workflow-to-review.md)
   + [Configuración del formulario adaptable para activar el flujo de trabajo](handling-form-submissions/trigger-workflow-on-form-submission.md)
   ...
   + [Flujo de trabajo de AEM PTO](handling-form-submissions/invoking-aem-workflow-on-form-submission-article-use.md)
...
+ Formularios adaptables {#adaptive-forms}
   ...
   + [Servicio de cumplimentación previa en Forms adaptable](adaptive-forms/prefill-service-adaptive-forms-article-use.md)
   ...
   + [Uso del valor establecido en XML en el flujo de trabajo OSGI](adaptive-forms/setvalue-aem-forms-workflow-tutorial-use.md)
   ...
   + [Uso de la API de GeoLocation](adaptive-forms/using-geolocation-api-in-aem-forms-article.md)
   + [Uso del Sistema de informes de transacciones](adaptive-forms/transaction-reporting-aem-forms-article-use.md)
   + [Integración de datos de Perfil de usuarios en AEM Forms](adaptive-forms/user-profile-data-integration-feature-video-use.md)
   ...
   + [Prueba automatizada de vídeo adaptable de Forms](adaptive-forms/calvin-sdk-test-adaptive-forms-feature-video.md)
   ...
   + [Uso del usuario de servicios en AEM Forms](adaptive-forms/service-user-tutorial-develop.md)
   + [Etiquetado y almacenamiento del documento de trabajo en envío de formulario adaptable](adaptive-forms/tagging-and-saving-document-of-record-in-dam-article-use.md)
   ...
   + [Flujo de trabajo de Form Data Model Service en AEM 6.4](adaptive-forms/form-data-model-service-as-step-in-workflow-video-use.md)
   ...
   + [Flujo de trabajo de Form Data Model Service en AEM 6.5.1](adaptive-forms/form-data-model-service-as-step-in-aem65-workflow-video-use.md)
   ...
   + [Configuración de la fuente de datos JDBC en AEM Forms](adaptive-forms/data-integration-technical-video-setup.md)
   + [Modelo de datos de formulario basado en JDBC](adaptive-forms/jdbc-data-model-technical-video-use.md)
   + [Crear asociaciones entre 2 entidades en el modelo de datos de formulario](adaptive-forms/association-data-model-technical-video-use.md)
   ...
   + [Publicar datos binarios para AEM DAM con el modelo de datos de formulario](adaptive-forms/form-data-model-to-post-binary-data-tutorial-use.md)
   + [Creación de modelos de flujo de trabajo reutilizables](adaptive-forms/re-usable-aem-forms-workflow-models-article.md)
   + [Flujo de trabajo AEM paso de proceso personalizado](adaptive-forms/custom-process-step-aem-workflow.md)
...
+ HTML5 Forms{#html5-forms}
   ...
   + [Administrar envío de formulario HTML5](html5-forms/handle-html5-form-submission.md)
+ AEM Forms y Adobe Sign{#forms-and-sign}
   ...
   + [Crear configuración de Adobe Sign Cloud](aem-forms-and-adobe-sign/create-adobe-sign-cloud-configuration.md)
   + [Crear flujo de trabajo para enviar documentos para firmar](aem-forms-and-adobe-sign/create-workflow-to-send-document-for-signing.md)
...
+ AEM Forms Con Marketing{#aem-forms-with-marketo}
   ...
   + [Parte 4 - Colocación de todo](aem-forms-with-marketo/part4.md)
...
+ AEM Forms con Adobe Campaign Standard{#aem-forms-with-adobe-campaign}
   ...
   + [Parte 3 - Cumplimentación previa del formulario mediante información de Perfil de ACS](aem-forms-with-adobe-campaign/partthree.md)
   + [Parte 4 - Crear Perfil ACS con el modelo de datos de formulario](aem-forms-with-adobe-campaign/partfour.md)

+ Servicios de documentos {#document-services}
   + [Uso del servicio de ensamblador en AEM Forms](document-services/using-assembler-service-in-aem-forms.md)
   ...
   + [Generar archivo PDF sobre envío de formulario móvil](document-services/generate-pdf-from-mobile-form-submission-article.md)
   + [Generar PDF interactivo a partir de formulario móvil](document-services/render-interactive-form-using-api.md)
   + [Aplicar derechos de uso a PDF en representación XDP](document-services/rendering-and-reader-extending-xdp-templates-article.md)
...
+ Comunicaciones interactivas para Canal impreso {#ic-print-channel-tutorial}
   + [Introducción](ic-print-channel-tutorial/introduction.md)
   + [Configurar Tomcat](ic-print-channel-tutorial/partone.md)
   + [Crear fuente de datos](ic-print-channel-tutorial/parttwo.md)
   + [Crear modelo de datos de formulario](ic-print-channel-tutorial/partthree.md)
   + [Creación de diseños XDP con Forms Designer](ic-print-channel-tutorial/partfour.md)
   + [Crear fragmento de Documento](ic-print-channel-tutorial/partfive.md)
   + [Crear Documento de Canal de impresión](ic-print-channel-tutorial/partsix.md)
   + [Añadir contenido en áreas de Destinatario](ic-print-channel-tutorial/partseven.md)
   + [Configuración del gráfico de líneas](ic-print-channel-tutorial/parteight.md)
   + [Añadir tabla a Canal de impresión](ic-print-channel-tutorial/partnine.md)
   + [Uso de la carpeta vigilada para generar Documentos de impresión](ic-print-channel-tutorial/partten.md)
   + [Apertura de la interfaz de usuario del agente en el envío del formulario](ic-print-channel-tutorial/parteleven.md)
...
+ Interactive Communications For Web Channel {#ic-web-channel-tutorial}
   ...
   + [Creación de fragmentos de Documento](ic-web-channel-tutorial/partfive.md)
   + [Creación de Documento de comunicación interactivo](ic-web-channel-tutorial/partsix.md)
   + [Añadir texto e imágenes](ic-web-channel-tutorial/partseven.md)
   ...
   + [Configuración del gráfico circular](ic-web-channel-tutorial/parteleven.md)
   + [Envío Del Documento Del Canal Web](ic-web-channel-tutorial/parttwelve.md)
   + [Envío de correo electrónico del Documento de Canal web](interactive-communications/delivery-of-web-channel-document-tutorial-use.md)