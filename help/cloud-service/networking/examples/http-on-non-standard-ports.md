---
title: Conexiones HTTP/HTTPS en puertos no estándar
description: Aprenda a realizar solicitudes HTTP/HTTPS de AEM as a Cloud Service a servicios web externos que se ejecuten en puertos no estándar.
...
# Conexiones HTTP/HTTPS en puertos no estándar
