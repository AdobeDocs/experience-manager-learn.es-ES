...
# Implementar la interfaz DataProvider

AEM Cree un proyecto de con el tipo de archivo más reciente y agregue el siguiente código al proyecto.
Normalmente, los datos se recuperan de una fuente de datos externa, como una base de datos, un almacenamiento de Azure, un contenedor S3 o cualquier otra fuente. Tendrá que escribir el código para recuperar los datos.
...
Incluya el siguiente código en su proyecto. El código anterior utiliza esta clase DataManager
...
Puede implementar el código en su entorno local preparado para la nube o en la instancia de nube de mediante Cloud Manager.
