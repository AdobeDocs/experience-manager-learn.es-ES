...
- Cree un nuevo repositorio Git de Cloud Manager para el proyecto WKND Sites y agréguelo como remoto al repositorio Git local:
   ...
   - Escriba un **Nombre de repositorio** (por ejemplo, &quot;wknd-site-tutorial&quot;) y haga clic en **Guardar**. Espere a que se cree el repositorio.
     ...
     ![Agregar repositorio](./assets/development-agent-troubleshoot-ci-cd-pipeline/add-repository.png)

   - Haga clic en **Acceder a la info del repositorio** en la esquina superior derecha y copie la URL del repositorio.

     ![Acceder a la info del repositorio](./assets/development-agent-troubleshoot-ci-cd-pipeline/access-repo-info.png)
...
- En el cuadro de diálogo **Agregar canalización que no sea de producción**, configure lo siguiente:
   ...
   - Paso **Configuración**:
     ...
     ![Agregar configuración de canalización que no sea de producción](./assets/development-agent-troubleshoot-ci-cd-pipeline/add-non-production-pipeline-configuration.png)
   ...
   - Paso **Código Source**:
     ...
     ![Agregar código Source de canalización que no sea de producción](./assets/development-agent-troubleshoot-ci-cd-pipeline/add-non-production-pipeline-source-code.png)
...
- Ejecute la canalización Calidad del código recién creada haciendo clic en **Ejecutar** en el menú de tres puntos de la entrada de la canalización.
  ...
  ![Ejecutar canalización de calidad de código](./assets/development-agent-troubleshoot-ci-cd-pipeline/run-code-quality-pipeline.png)
...
![Error de ejecución de canalización](./assets/development-agent-troubleshoot-ci-cd-pipeline/failed-pipeline-execution.png)
...
- Escriba los detalles del error de canalización en lenguaje natural conocido como **Prompt**. Por ejemplo:
  ...
  ![Invocar el agente de desarrollo de AEM](./assets/development-agent-troubleshoot-ci-cd-pipeline/invoke-aem-development-agent.png)
...
- Una vez que finalice el razonamiento, haga clic en el icono **Abrir en pantalla completa** para ver el proceso detallado de solución de problemas.
  ...
  ![Abrir en pantalla completa](./assets/development-agent-troubleshoot-ci-cd-pipeline/open-in-full-screen.png)
...
- En este caso, el agente sugirió correctamente cambiar la implementación (`getName()` método) o actualizar la prueba unitaria (`getNameTest()` método) para solucionar el problema. Evitó las alucinaciones y utilizó un enfoque de &quot;ser humano en el bucle&quot; mientras proporcionaba cambios de código procesables para el desarrollador.
  ...
  ![Copiar cambios de código](./assets/development-agent-troubleshoot-ci-cd-pipeline/copy-code-changes.png)
...
![Comparar ramas](./assets/development-agent-troubleshoot-ci-cd-pipeline/compare-branches.png)
