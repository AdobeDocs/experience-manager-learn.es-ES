...
### Página de inicio, Aventuras y Revistas
...
| Página | Qué va a ver | Cómo realizar pruebas | Experiencia |
|------|-----------------|-------------|------------|
...
### Páginas de aventuras y revistas (por lotes)
...
## Personalization de usuario conocido
...
El banner a pantalla completa de la página de inicio de WKND está personalizado en función de perfiles de usuario autenticados. Realice pruebas con estas cuentas de demostración para ver una experiencia personalizada:

| Página | Qué va a ver | Cómo realizar pruebas | Contexto de perfil | Experiencia |
|------|-----------------|-------------|-----------------|------------|
| [Hogar](https://wknd.enablementadobe.com/us/en.html){target="wknd"} | Interior de una tienda de esquí con **equipo de esquí premium con un &quot;EXTRA 25% de descuento&quot;** de promoción, con consejos de embalaje de expertos para prepararse para su próxima aventura de esquí | Inicie sesión con `teddy/teddy` o `asmith/asmith` y actualice la página | Aventuras de esquí compradas recientemente, con lo que se vende equipamiento de esquí | ![Venta adicional de equipo de esquí](./assets/live-demo/known-user-ski-gear-hero.png){width="200" zoomable="yes"} |
...
### Artículo destacado de la página principal
