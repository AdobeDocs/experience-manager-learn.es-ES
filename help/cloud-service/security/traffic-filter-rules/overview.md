...
Más información **Reglas del filtro de tráfico**, incluida su subcategoría de **Reglas del cortafuegos de aplicaciones web (WAF)** AEM en as a Cloud Service (AEMCS). Obtenga información sobre cómo crear, implementar y probar las reglas. AEM Además, analice los resultados para proteger los sitios de la.
...
>[!IMPORTANT]
>
> La subcategoría de reglas de filtro de tráfico denominadas &quot;reglas WAF&quot; requiere una licencia de protección WAF-DDoS


## Siguiente paso

Aprender [cómo realizar la configuración](./how-to-setup.md) la función para que pueda crear, implementar y probar las reglas del filtro de tráfico. Obtenga información acerca de la configuración de **Elasticsearch, Logstash y Kibana (ELK)** apilar herramientas del tablero para analizar los resultados de los registros de CDN de AEM CS.
