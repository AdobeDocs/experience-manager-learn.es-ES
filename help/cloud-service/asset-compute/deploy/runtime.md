---
title: Implementación de trabajadores de Asset compute en Adobe I/O Runtime AEM as a Cloud Service para su uso con
description: Los proyectos de asset compute, y los recursos que contienen, deben implementarse en Adobe I/O Runtime AEM para que los utilicen los as a Cloud Service de la aplicación de la aplicación de la aplicación de la aplicación de la.
...
Las demás variables estándar definidas en la variable `.env` as a Cloud Service proporciona implícitamente los archivos cuando invoca el Asset compute de trabajo de AEM.
