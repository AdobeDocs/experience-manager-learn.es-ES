...
Para obtener más información sobre la revisión de la estructura del proyecto, revise el [Anatomy of an Adobe Project Firefly project](https://www.adobe.io/project-firefly/docs/guides/).
