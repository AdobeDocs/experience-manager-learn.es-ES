---
title: Uso de la canalización de no producción de CI/CD de Adobe Cloud Manager
...
# Utilización de la CI/CD Pipeline de producción de Adobe Cloud Manager {#using-adobe-cloud-manager-ci-cd-production-pipeline}
