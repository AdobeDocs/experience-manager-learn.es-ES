...
>abstract="El desarrollo de Adobe Experience Manager (AEM) requiere que se instale y configure un conjunto mínimo de herramientas de desarrollo en el equipo de desarrollo. Estas herramientas incluyen Java, Maven, Adobe I/O CLI, entornos de desarrollo integrados y más."
...
### Configuración del complemento AEM Rapid Development Environment{#rde}

El complemento AEM Rapid Development Environment permite que la CLI de aio interactúe con AEM as a Cloud Service [Entornos de desarrollo rápido](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/rde/overview.html) a través de la variable `aio aem:rde` comando.

1. Ejecutar `aio plugins:install @adobe/aio-cli-plugin-aem-rde` para instalar el [Complemento AEM Rapid Development Entornos](https://github.com/adobe/aio-cli-plugin-aem-rde).
