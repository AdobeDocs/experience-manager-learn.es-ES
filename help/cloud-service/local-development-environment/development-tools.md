...
1. Ejecute `aio plugins:install @adobe/aio-cli-plugin-cloudmanager` para instalar el complemento de [Asset compute de aio](https://github.com/adobe/aio-cli-plugin-asset-compute).
