---
title: Integración de Adobe Experience Manager con Adobe Target mediante E/S de Experience Platform Launch y Adobe
seo-title: Integración de Adobe Experience Manager con Adobe Target mediante E/S de Experience Platform Launch y Adobe
description: Explicación paso a paso de cómo integrar Adobe Experience Manager con Adobe Target mediante E/S de Experience Platform Launch y Adobe
seo-description: Explicación paso a paso de cómo integrar Adobe Experience Manager con Adobe Target mediante E/S de Experience Platform Launch y Adobe
...
# Uso de Adobe Experience Platform Launch mediante la consola de E/S de Adobe

## Requisitos previos

* [AEM creación y publicación de instancias](./implementation.md#set-up-aem) que se ejecutan en los puertos localhost 4502 y 4503 respectivamente
* **Experience Cloud**
...
* **Complementos del explorador**
   ...
   * Iniciar y conmutador DTM ([Chrome](https://chrome.google.com/webstore/detail/launch-and-dtm-switch/nlgdemkdapolikbjimjajpmonpbpmipk))
...
3. En el conmutador de soluciones, haga clic en **Iniciar** y, a continuación, seleccione el botón **Ir a inicio** .
...
4. Asegúrese de que se encuentra en la organización correcta y, a continuación, continúe creando una propiedad Launch.
   ...
   *Para obtener más información sobre la creación de propiedades, consulte[Creación de una propiedad](https://docs.adobelaunch.com/administration/companies-and-properties#create-a-property)en la documentación del producto.*
5. Haga clic en el botón **Nueva propiedad**
6. Asigne un nombre a la propiedad (por ejemplo, *AEM tutorial* de Destinatario)
7. Como dominio, introduzca *localhost.com* ya que es el dominio en el que se ejecuta el sitio de demostración de WKND. Aunque el campo &#39;*Dominio*&#39; es obligatorio, la propiedad Launch funcionará en cualquier dominio en el que esté implementado. El objetivo principal de este campo es rellenar previamente las opciones de menú en el Generador de reglas.
...
1. En **Extensiones**, puede ver la lista de extensiones que ya están instaladas para la propiedad Launch. ([Experience Platform Launch Core Extension](https://exchange.adobe.com/experiencecloud.details.100223.adobe-launch-core-extension.html) está instalado de forma predeterminada)
...
5. Haga clic en **Guardar** para completar la adición de la Extensión de grupo de destinatarios a la propiedad Launch y debería poder ver la Extensión de grupo de destinatarios en la lista Extensiones **instaladas** .
...
4. Una vez finalizada la compilación, ejecute **Aprobar para publicación**, lo que moverá los cambios de un entorno de ensayo a un entorno de producción.
   ![Ensayo en producción](assets/using-launch-adobe-io/build-staging.png)
5. Finalmente, ejecute la opción **Generar y publicar en producción** para impulsar los cambios en la producción.
...
>[!NOTE]
>
> Otorgue a la integración de E/S de Adobe el acceso para seleccionar espacios de trabajo con la [función adecuada para permitir que un equipo central realice cambios impulsados por API en sólo unos pocos espacios](https://docs.adobe.com/content/help/en/target/using/administer/manage-users/enterprise/configure-adobe-io-integration.html)de trabajo.

1. Cree la integración de IMS en AEM mediante las credenciales de E/S de Adobe. (01:12 a 03:55)
2. En Experience Platform Launch, cree una propiedad. (cubierto [anteriormente](#create-launch-property))
...
En este punto, ha integrado correctamente [AEM con Adobe Target mediante Adobe Experience Platform Launch](./using-aem-cloud-services.md#integrating-aem-target-options) , tal como se detalla en la opción 1.
