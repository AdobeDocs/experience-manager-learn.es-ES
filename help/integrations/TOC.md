...
+ Categorías de soluciones{#solution-categories}
   ...
   + [Comercio](./solution-categories/commerce.md)
...
+ Integraciones de aplicaciones{#integrations-between-applications}
   ...
   + Experience Platform{#experience-platform}
      + [Análisis](./integrations-between-applications/experience-platform/experience-platform-analytics.md)
...
+ Tutorial{#tutorials}
   + Analytics y Commerce{#analytics-commerce}
      + [Analytics y Commerce](./tutorials/analytics-commerce/analytics-commerce.md)
   + Analytics y CJA{#analytics-cja}
      + [Analytics y CJA](./tutorials/analytics-customer-journey-analytics/experience-platform-source-connector.md)
   + Analytics y Real-Time CDP{#analytics-real-time-cdp}
      + [Analytics y Real-Time CDP](./tutorials/analytics-real-time-cdp/experience-platform-source-connector.md)
   + Analytics y Target{#analytics-target}
      + [Analytics y Target](./tutorials/analytics-target/analytics-target.md)
   + Campaign y Real-Time CDP{#campaign-real-time-cdp}
      + [Campaign v8 y Real-Time CDP](./tutorials/campaign-real-time-cdp/campaign-v8-real-time-cdp.md)
   + Real-Team CDP{#real-time-cdp-target}
      + [Real-Time CDP y Target](./tutorials/real-time-cdp-target/web-sdk-and-target-destination.md)